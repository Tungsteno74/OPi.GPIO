...
"""
Alternative pin mappings for OrangePi Zero board with/without Mini Shield
(see https://linux-sunxi.org/Xunlong_Orange_Pi_Zero)
...
.. code:: python
   ...
   GPIO.setmode(nanopi.zero.BOARD) or GPIO.setmode(nanopi.zero.BCM)
...
#OrangePi Zero physical board pin to GPIO pin
BOARD = {
...
# OrangePi Zero BCM pin to actual GPIO pin
BCM = {
