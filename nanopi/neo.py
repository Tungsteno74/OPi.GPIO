...
"""
Alternative pin mappings for NanoPi NEO board with/without Mini Shield
(see http://wiki.friendlyarm.com/wiki/index.php/NanoPi_NEO#Layout)
...
# NanoPi NEO physical board pin to GPIO pin
BOARD = {
    ...
    31:  17,    # PA17/SPDIF-OUT
    37:   4,    # PA4/UART_TXD0
    38:   5,    # PA5/UART_RXD0/PWM0
}

# NanoPi NEO BCM pin to actual GPIO pin
#WARNING: This MUST be tested, so it's not ready for production code.
#This pinout come from neocore2.py
BCM = {
